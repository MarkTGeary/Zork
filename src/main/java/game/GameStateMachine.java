...
class LostState implements GameStateMachine {
    ...
    private Room cell;
    LostState(GameCharacter player, Room storageRoomCloset, Room cell, StateMethods State) {
        this.player = player;
...
class StateMethods implements Serializable {
    ...
    public StateMethods(GameCharacter player, Room storageRoomCloset, Room cell) {
        this.player = player;
        this.storageRoomCloset = storageRoomCloset;
        this.cell = cell;
    }

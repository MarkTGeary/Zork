...
public class Room implements Serializable {
    ...
    public void onEnter(GameCharacter player, Room room, StateMethods status) {
    }


}
class Alarm implements Serializable {
    public static void ring(StateMethods state) {
...
class LockedRoom<T> extends Room implements Serializable {
    ...
    public void unlockKey(GameCharacter player, Item key, HintMethods hintStatus){
    ...
    public void enterCode(String code, GameCharacter player, Room cell, StateMethods state) {
